...
builder.Services.AddDbContext<_MyBlindTouchContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("_MyBlindTouchContext") ?? throw new InvalidOperationException("Connection string '_MyBlindTouchContext' not found.")));
