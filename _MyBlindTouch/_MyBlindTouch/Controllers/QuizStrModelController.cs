...
{
    public class QuizStrModelController : Controller
    {
        private readonly _MyBlindTouchContext _context;

        public QuizStrModelController(_MyBlindTouchContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Level,QuizStr")] QuizStrModel quizModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Level,QuizStr")] QuizStrModel quizModel)
        {
            if (id != quizModel.Id)
            {
                return NotFound();
